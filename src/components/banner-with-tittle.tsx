...
export function BannerWithTittle() {
  return (
    <div className="flex w-full flex-col items-center justify-center py-24">
      <p className="text-center text-4xl font-bold text-[#004AAD]">
      ...
      <div className="mt-4 flex w-full max-w-3xl flex-row items-start px-4">
        <Button
          variant="outline"
          className="mr-4 border border-[#11B856] bg-[#11B856] text-white hover:bg-white hover:text-[#11B856] md:flex"
        >
          <Link to="/abrir-empresa">Abrir empresa grátis</Link>
        </Button>
        <Button
          variant="outline"
          className="border border-[#FF914D] bg-[#FF914D] text-white hover:bg-white hover:text-[#FF914D] md:flex"
        >
